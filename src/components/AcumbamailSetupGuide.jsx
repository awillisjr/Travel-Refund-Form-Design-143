...
const { FiMail, FiSettings, FiCheck, FiCopy, FiExternalLink, FiKey, FiUser } = FiIcons;
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-yellow-700 text-sm">
              ...
              <a href="https://acumbamail.com/en/support/" target="_blank" rel="noopener noreferrer" 
                 className="underline ml-1">support documentation</a> or contact your development team.
            </p>
          </div>
        </div>
      </div>
